        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className={`transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="space-y-8">
              <div className="glass-card bg-card/5 backdrop-blur-xl border border-border rounded-2xl p-6 shadow-lg">
                <h3 className="text-2xl font-black text-foreground mb-4">GET IN TOUCH</h3>
              ...
              <div className="glass-card bg-gradient-to-br from-teal-500/20 to-orange-500/20 backdrop-blur-xl border border-border/30 rounded-2xl p-8 shadow-lg isometric-card">
                <LinkedinIcon className="w-16 h-16 text-blue-400 mx-auto mb-6 animate-pulse" />
                <h4 className="font-black text-foreground mb-3 text-xl text-center">CONNECT ON LINKEDIN</h4>
              ...
              <div className="space-y-4">
                {contactInfo.map((contact, index) => (
                  <div
                    key={index}
                    className={`glass-card bg-card/40 backdrop-blur-md border border-border hover:border-border/40 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 isometric-card ${contact.action ? 'cursor-pointer hover:-translate-y-1 ar-hover' : ''}`}
                    onClick={contact.action}
                  >
                    <div className="flex items-center gap-4">
                      <div className="p-3 bg-muted/80 rounded-xl border border-border/10">
          ...
          <div className={`transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="glass-card bg-gradient-to-br from-card/60 to-background/60 backdrop-blur-2xl border border-border/30 rounded-3xl p-8 shadow-lg isometric-card">
              <h3 className="text-2xl font-black text-foreground mb-6 neon-text-teal">SEND A MESSAGE</h3>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="block text-sm font-bold text-muted-foreground mb-2 tracking-wide">
                    YOUR NAME *
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full px-4 py-3 bg-background/40 border border-border rounded-lg focus:ring-2 focus:ring-teal-600 focus:border-teal-600 outline-none transition-all duration-200 text-foreground placeholder-muted-foreground backdrop-blur-sm"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-background/40 border border-border rounded-lg focus:ring-2 focus:ring-orange-600 focus:border-orange-600 outline-none transition-all duration-200 text-foreground placeholder-muted-foreground backdrop-blur-sm"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 bg-background/40 border border-border rounded-lg focus:ring-2 focus:ring-teal-600 focus:border-teal-600 outline-none transition-all duration-200 text-foreground placeholder-muted-foreground backdrop-blur-sm resize-none"
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-muted-foreground">
                ...
                <button
                  className="text-teal-400 hover:text-foreground font-bold ml-1 transition-colors hover:neon-glow-teal"
                  onClick={() => window.open("https://www.linkedin.com/in/shrashti-singhal-1869166b/", "_blank")}
                >
