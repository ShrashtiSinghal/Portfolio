      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-6 sm:px-8 lg:px-12">
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            {/* Left Content */}
            <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} flex flex-col items-center lg:items-start text-center lg:text-left`}>
              <div className="space-y-6 w-full flex flex-col items-center lg:items-start">
                {/* Neo-Brutalism Badge - Updated Text */}
                <div className="bg-gradient-to-r from-orange-500 to-orange-400 text-black font-black px-4 py-2 sm:px-6 sm:py-3 text-xs sm:text-sm transform -rotate-2 neo-brutal-btn-small animate-pulse-glow w-fit">
                  <span className="flex items-center gap-2">
                    <span className="w-2 h-2 sm:w-3 sm:h-3 bg-black rounded-full animate-ping"></span>
                ...
                <div>
                  ...
                  <div className="glass-card p-6 sm:p-8 border border-border backdrop-blur-xl bg-card/5 rounded-2xl mb-8 shadow-lg">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-foreground tracking-tight leading-tight mb-4">
              ...
              <div className="flex flex-col lg:flex-row items-center space-y-4 lg:space-y-0 lg:space-x-6 pt-4">
            ...
            <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="relative flex justify-center">
                ...
                <div className="glass-card relative z-10 p-4 bg-card/10 backdrop-blur-2xl border border-border rounded-3xl shadow-lg">
